...
public class RetrofitConfiguration
{
    ...
    @Bean
    public TransactionServiceCallable createTransactionServiceRequest(Retrofit.Builder secureKeyBuilder, @Value("${transaction.service.url}") String url)
    {

        return secureKeyBuilder.baseUrl(url).build().create(TransactionServiceCallable.class);
    }
       ...
       @Bean
       public ProductServiceCallable createProductServiceRequest(Retrofit.Builder secureKeyBuilder,  @Value("${product.service.url}") String url)
       {

           return secureKeyBuilder.baseUrl(url).build().create(ProductServiceCallable.class);
       }
